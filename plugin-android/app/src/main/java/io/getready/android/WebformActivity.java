    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                if (url.startsWith(WebformPlugin.webformRedirectScheme)) {
        ...
        webView.loadUrl(WebformPlugin.webformUrl);
    }

    private static void onWebformRedirect(String url) {
        WebformPlugin.onWebformRedirect(url);
    }

    private static void onWebformActionCancel() {
        WebformPlugin.onWebformRedirect("canceled");
    }
