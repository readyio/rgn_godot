...
struct G_BuyVirtualItemsResponse {
	static void ConvertToGodotModel(const RGN::Modules::Store::BuyVirtualItemsResponse& source, godot::Dictionary& target) {
	...
	static void ConvertToCoreModel(const godot::Dictionary& source, RGN::Modules::Store::BuyVirtualItemsResponse& target) {
