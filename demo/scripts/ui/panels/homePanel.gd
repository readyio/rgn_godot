...
func _ready():
	currencyButton.connect("pressed", _onCurrencyButtonPressed)
	inventoryButton.connect("pressed", _onInventoryButtonPressed)
	achievementsButton.connect("pressed", _onAchievementsButtonPressed)
	storeButton.connect("pressed", _onStoreButtonPressed)
	walletsButton.connect("pressed", _onWalletsButtonPressed)
	userProfileButton.connect("pressed", _onUserProfileButtonPressed)
	signOutButton.connect("pressed", _onSignOutButtonPressed)
